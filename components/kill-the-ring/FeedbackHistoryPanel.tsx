...
import { History, Download, Trash2, AlertTriangle, TrendingUp, BarChart3, Inbox } from 'lucide-react'
            ...
            <ScrollArea className="h-[250px]">
                ...
                {hotspots.length === 0 ? (
                  <div className="flex flex-col items-center justify-center gap-2 py-8 text-muted-foreground">
                    ...
                    <span className="text-sm">No feedback events recorded yet.</span>
                    <span className="text-xs opacity-60">Events will appear here as they are detected.</span>
                  </div>
                ) : (
